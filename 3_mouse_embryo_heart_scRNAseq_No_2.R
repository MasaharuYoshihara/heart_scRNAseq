...
dat_merge <- readRDS("20260307_mouse_embryo_heart_scRNAseq_merge_before_QC.rds")

# dat_merge
# An object of class Seurat 
# 18738 features across 56068 samples within 1 assay 
# Active assay: RNA (18738 features, 0 variable features)
# 7 layers present: counts.10.5, counts.12.5_1, counts.12.5_2, counts.14.5_1, counts.14.5_2, counts.16.5_1, counts.16.5_2
...
dat_merge <- IntegrateLayers(object = dat_merge, method = HarmonyIntegration, 
                             orig.reduction = "pca",new.reduction = 'harmony', 
                             verbose = FALSE)

# dat_merge
# An object of class Seurat 
# 18738 features across 53356 samples within 1 assay 
# Active assay: RNA (18738 features, 2000 variable features)
# 15 layers present: counts.10.5, counts.12.5_1, counts.12.5_2, counts.14.5_1, counts.14.5_2, counts.16.5_1, counts.16.5_2, data.10.5, data.12.5_1, data.12.5_2, data.14.5_1, data.14.5_2, data.16.5_1, data.16.5_2, scale.data
# 2 dimensional reductions calculated: pca, harmony

saveRDS(dat_merge, "20260307_mouse_embryo_heart_scRNAseq_after_harmony.rds")
...
# [19] promises_1.5.0         purrr_1.2.1           
# [21] jsonlite_2.0.0         goftest_1.2-3         
# [23] later_1.4.7            spatstat.utils_3.2-1  
# [25] irlba_2.3.7            parallel_4.5.1        
# [27] cluster_2.1.8.2        R6_2.6.1              
# [29] ica_1.0-3              stringi_1.8.7         
# [31] RColorBrewer_1.1-3     spatstat.data_3.1-9   
# [33] reticulate_1.45.0      parallelly_1.46.1     
# [35] spatstat.univar_3.1-6  lmtest_0.9-40         
# [37] scattermore_1.2        Rcpp_1.1.1            
# [39] tensor_1.5.1           future.apply_1.20.2   
# [41] zoo_1.8-15             sctransform_0.4.3     
# [43] httpuv_1.6.16          Matrix_1.7-4          
# [45] splines_4.5.1          igraph_2.2.2          
# [47] tidyselect_1.2.1       abind_1.4-8           
# [49] codetools_0.2-20       spatstat.random_3.4-4 
# [51] miniUI_0.1.2           spatstat.explore_3.7-0
# [53] listenv_0.10.0         lattice_0.22-9        
# [55] tibble_3.3.1           plyr_1.8.9            
# [57] withr_3.0.2            shiny_1.13.0          
# [59] S7_0.2.1               ROCR_1.0-12           
# [61] Rtsne_0.17             future_1.69.0         
# [63] fastDummies_1.7.5      survival_3.8-6        
# [65] polyclip_1.10-7        fitdistrplus_1.2-6    
# [67] pillar_1.11.1          KernSmooth_2.23-26    
# [69] plotly_4.12.0          generics_0.1.4        
# [71] RcppHNSW_0.6.0         scales_1.4.0          
# [73] globals_0.19.0         xtable_1.8-8          
# [75] RhpcBLASctl_0.23-42    glue_1.8.0            
# [77] lazyeval_0.2.2         tools_4.5.1           
# [79] data.table_1.18.2.1    RSpectra_0.16-2       
# [81] RANN_2.6.2             dotCall64_1.2         
# [83] cowplot_1.2.0          grid_4.5.1            
# [85] tidyr_1.3.2            nlme_3.1-168          
# [87] patchwork_1.3.2        cli_3.6.5             
# [89] spatstat.sparse_3.1-0  spam_2.11-3           
# [91] viridisLite_0.4.3      uwot_0.2.4            
# [93] gtable_0.3.6           digest_0.6.39         
# [95] progressr_0.18.0       ggrepel_0.9.7         
# [97] htmlwidgets_1.6.4      farver_2.1.2          
# [99] htmltools_0.5.9        lifecycle_1.0.5       
# [101] httr_1.4.8             mime_0.13             
# [103] harmony_1.2.4          MASS_7.3-65  
