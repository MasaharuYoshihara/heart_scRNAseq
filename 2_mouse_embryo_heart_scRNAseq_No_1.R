...
count_10.5 <- ReadMtx(mtx = "GSM3465996_matrix.mtx.gz",
                      features = "GSM3465996_genes.tsv.gz",
                      cells = "GSM3465996_barcodes.tsv.gz")

seurat_10.5 <- CreateSeuratObject(count_10.5, project = "10.5",
                                  min.cells = 3, min.features = 200)

# seurat_10.5
# An object of class Seurat 
# 17137 features across 10933 samples within 1 assay 
# Active assay: RNA (17137 features, 0 variable features)
...
merge <- merge(x = seurat_10.5,
               y = c(seurat_12.5_1, seurat_12.5_2,
                     seurat_14.5_1, seurat_14.5_2,
                     seurat_16.5_1, seurat_16.5_2),
               add.cell.ids = c("10.5",
                                "12.5_1", "12.5_2",
                                "14.5_1", "14.5_2",
                                "16.5_1", "16.5_2"))

saveRDS(merge, "20260307_mouse_embryo_heart_scRNAseq_merge_before_QC.rds")
